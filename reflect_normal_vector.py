...
def getOptions():
    ...
    userOptions['x'] = {}
    userOptions['x']['label'] = 'X component of the Normal vector'
    userOptions['x']['type'] = 'float'
    userOptions['x']['default'] = 0

    userOptions['y'] = {}
    userOptions['y']['label'] = 'Y component of the Normal vector'
    userOptions['y']['type'] = 'float'
    userOptions['y']['default'] = 0

    userOptions['z'] = {}
    userOptions['z']['label'] = 'Z component of the Normal vector'
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser('Reflect across plane defined by specified normal vector')
    ...
    if args['display_name']:
        print("Reflect across plane defined by specified normal vector")
    if args['menu_path']:
        print("&Build")
